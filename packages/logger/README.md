...
- **格式固定**：`[UTC+8 ISO] level [channel] message key=value ...`，人眼读、grep 都顺手。
...
```text
[2026-05-09T16:00:00.000+08:00] info  [myapp] server started port=3000
[2026-05-09T16:00:00.001+08:00] debug [myapp] loaded modules count=42
```
...
// => === run start 2026-05-09T16:00:00.000+08:00 mode=dev pid=12345 version=0.1.0 ===
```
...
- `<iso>`：UTC+8 ISO-8601，毫秒精度，例 `2026-05-09T16:00:00.000+08:00`。
...
```text
=== run start 2026-05-09T16:00:00.000+08:00 mode=dev pid=12345 version=0.1.0 ===
[2026-05-09T16:00:00.456+08:00] info  [server:boot] server listening url=http://127.0.0.1:54321
[2026-05-09T16:00:01.789+08:00] debug [server:agent:stream] chunk type=text-delta len=42
[2026-05-09T16:00:02.111+08:00] error [server:route:agent] streamAgent failed err="model timeout"
  Error: model timeout
      at streamText (...)
```
